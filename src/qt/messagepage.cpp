...

{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a Datacoin address (e.g. DAj5jfmktTfmxby6MQ8qUswqWCRpdvZ34c)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));
    ui->addressIn_VM->setPlaceholderText(tr("Enter a Datacoin address (e.g. DAj5jfmktTfmxby6MQ8qUswqWCRpdvZ34c)"));
    ...
    ui->addressIn_ED->setPlaceholderText(tr("Enter a Datacoin address"));
    ui->addressIn_DD->setPlaceholderText(tr("Enter a Datacoin address"));
